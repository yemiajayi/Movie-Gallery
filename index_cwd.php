...
// Default: $_CONFIG['main_title'] = "Directory Content";
//
$_CONFIG['main_title'] = "Directory Content";
...
//
$_CONFIG['secondary_titles'] = array("Contents of the current working directory");
...
//
$_CONFIG['users'] = array(); //(array("yemi", "Dfasje01", "admin"));
...
/***************************************************************************/
//Yoruba
$_TRANSLATIONS["yr"] = array(
  "file_name" => "Oruko faili",
  "size" => "Iwon",          
  "last_changed" => "Ijo atunse",
  "total_used_space" => "aaye tia ti lo",
  "free_space" => "aaye to seku",
  "password" => "kokoro",
  "upload" => "fikun n",
  "failed_upload" => "fikun kuna!",
  "failed_move" => "gbe e kuna!",
  "wrong_password" => "kokoro buruku!!",
  "make_directory" => "se apo tuntun",
  "new_dir_failed" => "sisi apo tuntun kuna",
  "chmod_dir_failed" => "chmod apo kuna",
  "unable_to_read_dir" => "Kika apo kuna",
  "location" => "Ibugbe",
  "root" => "Idi"
  );
// Albanian
...
table.table tr.row.one {
	background-color:#f8f9fa;          /*#efffef*/
}
...
<!--<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">           <!--bootstrap cdn link to make table responsive-->
</head>
